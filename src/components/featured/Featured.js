  ...
  return (
    <div className="featured">
      ...
      <div className="container">
        ...
        <div className="span-2 right-image-details">
          <p>This is one of the finest homes you would get in this price!</p>
      ...
      <div className="container">
        ...
        <div className="span-2 right-image-details order-7">
          <p>This is one of the finest homes you would get in this price!</p>
          <button className="btn">View Listing</button>
        </div>
